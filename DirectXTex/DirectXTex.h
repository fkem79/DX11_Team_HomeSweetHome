...
namespace DirectX
{
    ...
    struct TexMetadata
    {
        ...
        void __cdecl SetAlphaMode(TEX_ALPHA_MODE shaderMode) noexcept { miscFlags2 = (miscFlags2 & ~static_cast<uint32_t>(TEX_MISC2_ALPHA_MODE_MASK)) | static_cast<uint32_t>(shaderMode); }
